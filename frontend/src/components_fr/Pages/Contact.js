	...
	<div>
		<Grid container spacing={2} alignItems="center">
			...
			<Grid container item spacing={2} alignItems="center">
				...
				<Grid item xs={5} md={3}>	
					<TextField fullWidth id="outlined-basic" label="Nom" value={name} onChange={handleChangeName} variant="outlined" />
				</Grid>
				
				<Grid item xs={7} md={4}>	
					<TextField fullWidth id="outlined-basic" label="Votre email" value={email} onChange={handleChangeEmail} variant="outlined" />
				</Grid>
				
				<Grid item xs={12} md={5}>	
					<TextField fullWidth id="outlined-basic" label="Objet" value={subject} onChange={handleChangeSubject} variant="outlined" />
				</Grid>		
			</Grid>
		...
		<Snackbar open={success} autoHideDuration={6000} onClose={handleCloseSuccess} >
			<Alert onClose={handleCloseSuccess} severity="success" sx={{ width: '100%' }}>
				{"Email envoyé ! Je vous répondrai sous peu."}
			</Alert>
		</Snackbar>
