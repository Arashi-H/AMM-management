...
export interface LIQUIDITYInterface extends utils.Interface {
  functions: {
    ...
    "setAMM_Address(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setAMM_Address",
    values: [string]
  ): string;
  encodeFunctionData(
...
export interface LIQUIDITY extends BaseContract {
  ...
  functions: {
    AMM_Address(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    AMM_Address(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    AMM_Address(overrides?: CallOverrides): Promise<PopulatedTransaction>;
